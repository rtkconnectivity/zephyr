...
#ifndef ZEPHYR_INCLUDE_DRIVERS_DMA_RTL8752H_H_
#define ZEPHYR_INCLUDE_DRIVERS_DMA_RTL8752H_H_

#define RTL8752H_DMA_CTLR(id, dir)           DT_INST_DMAS_CTLR_BY_NAME(id, dir)
#define RTL8752H_DMA_CHANNEL_CONFIG(id, dir) DT_INST_DMAS_CELL_BY_NAME(id, dir, config)

/* macros for channel-config */
/* direction defined on bits 0-1 */
/* 0 -> MEM_TO_MEM, 1 -> MEM_TO_PERIPH, 2 -> PERIPH_TO_MEM */
#define RTL8752H_DMA_CONFIG_DIRECTION(config) ((config >> 0) & 0x3)

/* source increment defined on bit 2-3 */
/* 0 -> increment, 1 -> decrement, 2 -> no change */
#define RTL8752H_DMA_CONFIG_SOURCE_ADDR_INC(config) ((config >> 2) & 0x3)

/* destination increment defined on bit 4-5 */
/* 0 -> increment, 1 -> decrement, 2 -> no change */
#define RTL8752H_DMA_CONFIG_DESTINATION_ADDR_INC(config) ((config >> 4) & 0x3)
...
#endif /* ZEPHYR_INCLUDE_DRIVERS_DMA_RTL8752H_H_ */
