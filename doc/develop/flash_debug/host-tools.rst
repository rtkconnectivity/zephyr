...
After downloading the archive of MPCli, extract it and choose the version compatible with your operating system. Then, add the directory containing the ``mpcli`` executable to your system
