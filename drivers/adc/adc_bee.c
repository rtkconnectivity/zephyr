...
static const struct adc_driver_api adc_bee_driver_api = {
...
#define BEE_ADC_INIT(index)                                                                        \
	...
	PM_DEVICE_DT_INST_DEFINE(index, adc_bee_pm_action);                                        \
	DEVICE_DT_INST_DEFINE(index, &adc_bee_init, PM_DEVICE_DT_INST_GET(index),                  \
			      &adc_bee_data_##index, &adc_bee_config_##index, POST_KERNEL,         \
			      CONFIG_ADC_INIT_PRIORITY, &adc_bee_driver_api);
